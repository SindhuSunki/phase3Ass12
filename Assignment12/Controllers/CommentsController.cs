...
namespace Assignment12.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Content,PublicationDate,PostId")] Comments comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Content,PublicationDate,PostId")] Comments comment)
        {
            if (ModelState.IsValid)
            {
